...
import prk_method.Valid_Halton as Find_valid_halton
import Important_functions.Convert_1D2D as convert

    
def main():
    output_path = 'With_Energy/One-batch-Lobatto-Outputs/'
    ...
    A1D_original_BeforeOptimization = convert.Convert_toOneD(A1, A2, B1, B2)
    """
    ######################################
    """
    ...
    min_error_A1D = None
    adam_max_iters = 1200 # 120000
    
    for k in trange(60000000):
        tot_error = 0
        tot_error_energy = 0
