...
import prk_method.Random_prk_for_optimization as IRK4
import Important_functions.Convert_1D2D as convert


def main():
    output_path = 'With_Energy/One-Random-Outputs/'
    ...
    """ Random Initial weight selections
    """
    ...
    batch_size = 100  # Set the batch size to 10
