...
def find_error(A1D, H_sequence):
    ...
    init_state_iyz = iyn_list, izn_list, iy, iz, LA1, LA2, LB1, LB2, alpha_values, h, isteps
    ...
    return yn_list, zn_list, H #jnp.add(jnp.sum(final_error), energy_error), energy_error, yn_list, zn_list, H #, step_size_list_convergence, o_error_list_convergence
...
# # @jit
# # def Energy_Function(q, p, alpha_values):
# #     omega = 1 ## 1 or 10 , or any value
# #     p = jnp.array(p, dtype=jnp.float64)
# #     q = jnp.array(q, dtype=jnp.float64)
# #     omega = jnp.array(omega, dtype=jnp.float64)
# #     return (0.5 * jnp.square(p)) + (0.5 * omega**2 * jnp.square(q))
...
# #     # print("----------")
# #     # print(alpha_values)
# #     # print(alpha_values[0], alpha_values[1], alpha_values[2], alpha_values[3])
# #     # print("----------")
...
#     i = 0
#     total_steps = int(times*time_factor * NN)
#     total_isteps = int(times*time_factor * isteps * NN)
...
#     init_state_iyz = iyn_list, izn_list, iy, iz, A1, A2, B1, B2, alpha_values, h, isteps
#     iyn_list, izn_list, _, _, _, _, _, _, _, _, _ = jax.lax.fori_loop(0, total_isteps, fori_loop_2, init_state_iyz) # time istep
...
#     ### no regularizer here :
#     return jnp.add(jnp.sum(final_error) , energy_error) , energy_error, yn_list, zn_list, H #, step_size_list_convergence, o_error_list_convergence
