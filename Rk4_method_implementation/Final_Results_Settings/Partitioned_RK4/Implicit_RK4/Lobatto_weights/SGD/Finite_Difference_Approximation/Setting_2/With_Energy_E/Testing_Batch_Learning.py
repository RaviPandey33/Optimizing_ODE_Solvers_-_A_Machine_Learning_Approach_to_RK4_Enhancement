...
with open('With_Energy/S1_Outputs/Error.txt', 'w') as S1_output, open('With_Energy/S1_Outputs/Energy.txt', 'w') as S1_energy, open('With_Energy/S1_Outputs/Validation.txt', 'w') as S1_validation, open('With_Energy/S1_Outputs/Final_weights.txt', 'w') as S1_weights:
    ## Batch Size
