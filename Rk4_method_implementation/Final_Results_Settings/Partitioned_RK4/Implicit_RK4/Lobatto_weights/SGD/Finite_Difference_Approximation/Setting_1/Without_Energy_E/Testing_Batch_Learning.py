...
compute_grads_batched = jax.vmap(numerical_gradient, in_axes=(None, 0)) # 2 options jacfwd or numeric_gradient
...
with open('Without_Energy/S1_Outputs/Error.txt', 'w') as S1_output, open('Without_Energy/S1_Outputs/Energy.txt', 'w') as S1_energy, open('Without_Energy/S1_Outputs/Validation.txt', 'w') as S1_validation, open('Without_Energy/S1_Outputs/Final_weights.txt', 'w') as S1_weights:
    ## Batch Size
