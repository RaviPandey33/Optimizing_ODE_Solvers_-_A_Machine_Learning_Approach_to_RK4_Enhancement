...
with open('With_Energy/S1_Outputs/Perturbed_Error.txt', 'w') as S1_output, open('With_Energy/S1_Outputs/Perturbed_Energy.txt', 'w') as S1_energy, open('With_Energy/S1_Outputs/Perturbed_Validation.txt', 'w') as S1_validation, open('With_Energy/S1_Outputs/Perturbed_Final_weights.txt', 'w') as S1_weights:
    ## Batch Size
