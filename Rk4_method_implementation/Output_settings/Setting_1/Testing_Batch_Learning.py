...
with open('S1_Error.txt', 'w') as S1_output :
    with open('S1_Final_weights.txt', 'w') as S1_weights:
        ## Batch Size
...
# with open('S1_output_error.txt', 'w') as S1_output and open('S1_Final_weights.txt', 'w') as S1_weights:
#     ## Batch Size
#     batch_size = 100 ## just to remind you right now total halton sequence is also 100, so we are taking the whole set as the batch.
#     validation_batch_size = 50
