...
compute_grads_batched = jax.vmap(jacfwd_gradient, in_axes=(None, 0)) # 2 options jacfwd or numeric gradient
...
with open('Outputs/S1_Error.txt', 'w') as S1_output, open('Outputs/S1_Energy.txt', 'w') as S1_energy, open('Outputs/S1_Validation.txt', 'w') as S1_validation, open('Outputs/S1_Final_weights.txt', 'w') as S1_weights:
    ## Batch Size
