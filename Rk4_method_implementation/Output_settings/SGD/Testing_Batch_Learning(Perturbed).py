...
with open('Outputs/Perturbed_S1_Error.txt', 'w') as S1_output, open('Outputs/Perturbed_S1_Energy.txt', 'w') as S1_energy, open('Outputs/Perturbed_S1_Validation.txt', 'w') as S1_validation, open('Outputs/Perturbed_S1_Final_weights.txt', 'w') as S1_weights:
    ## Batch Size
